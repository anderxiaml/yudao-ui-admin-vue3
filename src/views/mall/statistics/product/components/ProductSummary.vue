  ...
  <el-card shadow="never">
    ...
    <el-row :gutter="16">
      <el-col :xl="4" :md="8" :sm="24">
        <SummaryCard
          title="菜品浏览量"
          tooltip="在选定条件下，所有菜品详情页被访问的次数，一个人在统计时间内访问多次记为多次"
          icon="ep:view"
      ...
      <el-col :xl="4" :md="8" :sm="24">
        <SummaryCard
          title="菜品访客数"
          tooltip="在选定条件下，访问任何菜品详情页的人数，一个人在统计时间范围内访问多次只记为一个"
          icon="ep:user-filled"
...
const trendLoading = ref(true) // 菜品状态加载中
const exportLoading = ref(false) // 导出的加载中
const trendSummary = ref<DataComparisonRespVO<ProductStatisticsVO>>() // 菜品状况统计数据
...
const lineChartOptions = reactive<EChartsOption>({
  ...
  series: [
    { name: '菜品浏览量', type: 'line', smooth: true, itemStyle: { color: '#B37FEB' } },
    { name: '菜品访客数', type: 'line', smooth: true, itemStyle: { color: '#FFAB2B' } },
  ...
  toolbox: {
    feature: {
      ...
      saveAsImage: { show: true, name: '菜品状况' } // 保存为图片
    }
  },
  tooltip: {
    trigger: 'axis',
